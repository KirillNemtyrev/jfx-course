...
public class UpdatePhotoHandler implements Callback<ResponseBody> {
    ...
    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
        ...
        if (!response.isSuccessful()) {
            messageDraw.setMessage("Ошибка", "Не удалось обновить фотографию..");
            messageDraw.error();
            messageDraw.show();
            return;
        }
        ...
        messageDraw.setMessage("Успешно", "Вы успешно изменили аватарку!");
        messageDraw.info();
        messageDraw.show();
